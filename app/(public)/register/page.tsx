    ...
    <div className="relative min-h-screen flex items-center justify-center bg-linear-to-br from-gray-200 to-gray-200 px-6 overflow-hidden">
      ...
      >
        <button
          ...
          className="flex items-center text-teal-600 hover:text-teal-700 transition-colors mb-2"
        >
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-5 py-4 text-lg border rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent placeholder-gray-400 bg-white/90"
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-2 text-white py-4 text-lg rounded-xl font-semibold transition-all duration-200 disabled:opacity-60 shadow-sm ${loading
            ? 'bg-linear-to-r from-teal-500 to-teal-400 animate-pulse'
